...
| **ADR-005** | [Container Runtime Isolation on Proxmox VE](./architecture-decision-records/005-container-runtime-isolation-proxmox-lxc.md) | 2026-08-16 | Compute / Namespace Isolation | Accepted |
